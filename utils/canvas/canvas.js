...
module.exports = class CanvasTemplates {
    ...
    static async rank({ author, message, levelUtils, topRank, client, lang }) {
        ...
        const avatar = await loadImage(author.displayAvatarURL({ extension: "png" }));
        //const avatar = await loadImage("https://cdn.discordapp.com/avatars/" + author.id + "/" > + author.avatar + ".png");
    ...
    static async profile({ author, message }) {
        ...
        const avatarLoad = author.displayAvatarURL({ extension: "png" })
